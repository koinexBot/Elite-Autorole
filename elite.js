...
client.channels.find('id', '521743798682910720').setName("●");
client.channels.find('id', '521743798682910720').setName("● É");
client.channels.find('id', '521743798682910720').setName("● Él");
client.channels.find('id', '521743798682910720').setName("● Éli");
client.channels.find('id', '521743798682910720').setName("● Élit");
client.channels.find('id', '521743798682910720').setName("● Élite");
client.channels.find('id', '521743798682910720').setName("● Élite S");
client.channels.find('id', '521743798682910720').setName("● Élite Se");
client.channels.find('id', '521743798682910720').setName("● Élite Ser");
client.channels.find('id', '521743798682910720').setName("● Élite Serv");
client.channels.find('id', '521743798682910720').setName("● Élite Serve");
client.channels.find('id', '521743798682910720').setName("● Élite Server");
client.channels.find('id', '521743798682910720').setName("● Élite Server ,");
client.channels.find('id', '521743798682910720').setName("● Élite Server ,,");
client.channels.find('id', '521743798682910720').setName("● Élite Server ,,,");
client.channels.find('id', '521743798682910720').setName("● Élite Server ,,, 1");
client.channels.find('id', '521743798682910720').setName("● Élite Server ,,, 1K");
client.channels.find('id', '521743798682910720').setName("● Élite Server ,,, 1K .");
client.channels.find('id', '521743798682910720').setName("● Élite Server ,,, 1K ..");
  }, 3000);
});
...
if(ar[member.guild.id].onoff === 'مفعل') return;
...
client.on('message',async message => {
	    ...
	    if(message.content.startsWith(prefix + "setCatgory")) {
                message.guild.createChannel("● Élite » Info", "category");
		    const CATGORY = new Discord.RichEmbed()
     .setDescription(`**☑ | تم ... إنشاء الروم بنجاح**`)
     .setColor(000000)
     .setAuthor(`${message.author.tag}`, message.author.avatarURL)
     .setFooter(`Requested By ${message.author.username}` , message.author.avatarURL)
     .setTimestamp();
      message.channel.send(CATGORY);
	    }
    if(message.content.startsWith(prefix + "setVoice")) {
	 let elite = message.guild.channels.find("name", "● Élite » Info");
	    	     const nos2category = new Discord.RichEmbed()
     .setDescription(`**:x: | \`\`${prefix}setCatgory\`\` من فضلك ... إستخدام أمر**`)
     .setColor(000000)
     .setAuthor(`${message.author.tag}`, message.author.avatarURL)
     .setFooter(`Requested By ${message.author.username}` , message.author.avatarURL)
     .setTimestamp();	
     if(!elite) return message.channel.send(nos2category);
...
let elite = message.guild.channels.find("name", "● Élite » Info");
  ...
  const nopermission = new Discord.RichEmbed()
    ...
    message.guild.createChannel(`👪 - Members Count : 「${message.guild.memberCount}」` , 'voice').then(c => {
		 c.setParent(elite);
      c.overwritePermissions(message.guild.id, {
        CONNECT: false,
        SPEAK: false
